...
기본 원칙은 같지만 계절에 따라 한두 가지 항목이 달라집니다. 짐이 늘어나는 계절일수록 무엇을 빼야 하는지가 더 중요해집니다.

**여름**에는 땀 때문에 상의 여분이 하나 더 필요하고, 대신 겉옷은 실내 냉방용 얇은 것 하나면 됩니다. 물놀이가 있으면 수영복과 젖은 옷을 담을 방수 주머니를 챙기고, 자외선 차단제와 모자는 부피가 작으니 빼지 않습니다. 세면도구는 숙소 제공품을 믿되 땀 냄새를 관리할 데오드란트 정도는 직접 챙깁니다.

**겨울**에는 겉옷이 짐의 대부분을 차지하므로 가장 두꺼운 옷은 입고 이동합니다. 가방에는 얇은 보온 내의와 두꺼운 양말, 장갑처럼 부피가 작은 보온 용품을 넣습니다. 실내가 따뜻한 곳에서는 두꺼운 겉옷을 벗고 얇은 옷으로 지낼 수 있게 상의는 얇은 것 여러 겹으로 준비합니다. 핫팩은 몇 개만 챙기고 현지에서 살 수 있다는 점을 기억합니다.

**장마철과 환절기**에는 날씨가 하루 안에 바뀝니다. 접는 우산 하나, 방수가 되는 얇은 겉옷 하나, 여분 양말 한 켤레가 기본이고, 신발은 젖어도 빨리 마르는 것을 신습니다. 젖은 옷을 따로 담을 지퍼백은 이 계절에 가장 자주 쓰입니다. 출발 전날 시간대별 강수 확률을 보고 우산과 방수 겉옷 중 하나만 챙길 수 있는지 판단하면 짐을 조금 더 줄일 수 있습니다.

  ...
  return (
    <div className="shell shell--narrow legal">
      ...
      <section aria-labelledby="p1">
        <h2 id="p1">제1조 적용 범위와 개인정보처리자</h2>
        <p>
      ...
      <section aria-labelledby="p2">
        <h2 id="p2">제2조 수집하는 개인정보의 항목과 방법</h2>
        <p>
      ...
      <section aria-labelledby="p4">
        <h2 id="p4">제4조 개인정보의 보유 및 이용 기간</h2>
        <p>
      ...
      <section aria-labelledby="p5">
        <h2 id="p5">제5조 개인정보의 파기 절차와 방법</h2>
        <p>
      ...
      <section aria-labelledby="p6">
        <h2 id="p6">제6조 개인정보의 제3자 제공</h2>
        <p>
          운영자는 이용자의 개인정보를 판매하지 않으며, 법령에 근거한 요청이 있는 경우를 제외하고 이용자의 동의 없이
          제3자에게 제공하지 않습니다. 다만 제9조의 광고 서비스처럼 이용자의 브라우저에서 제3자가 쿠키를 통해 직접
          수집하는 경우는 제9조에 따릅니다.
        </p>
      </section>

      <section aria-labelledby="p7">
        <h2 id="p7">제7조 개인정보 처리의 위탁과 국외 이전</h2>
        <p>
          사이트 운영을 위해 아래 서비스 제공자에게 업무를 위탁하며, 이 과정에서 접속 정보가 국외(미국) 서버에서
          처리될 수 있습니다. 이전은 이용자가 사이트에 접속하거나 문의를 보내는 시점에 네트워크를 통해 이루어지며, 각
          제공자는 자체 개인정보 보호정책과 계약 조건에 따라 정보를 보호합니다. 각 제공자의 이용 목적과 보유 기간,
          연락 방법은 아래 표의 개인정보 보호정책 링크에서 확인할 수 있습니다.
        </p>
      ...
      <section aria-labelledby="p8">
        <h2 id="p8">제8조 쿠키 등 자동 수집 장치의 설치·운영과 거부</h2>
        <p>
          쿠키는 웹사이트가 이용자의 브라우저에 저장하는 작은 텍스트 파일입니다. 사이트는 기본 기능 제공, 보안, 광고
          게재를 위해 쿠키 또는 이와 비슷한 기술을 사용할 수 있습니다.
        </p>
      ...
      <section aria-labelledby="p10">
        <h2 id="p10">제10조 정보주체의 권리와 행사 방법</h2>
        <p>
      ...
      <section aria-labelledby="p11">
        <h2 id="p11">제11조 만 14세 미만 아동의 개인정보</h2>
        <p>
      ...
      <section aria-labelledby="p15">
        <h2 id="p15">제15조 방침의 변경과 개정 이력</h2>
        <p>
          법령이나 서비스 내용이 바뀌면 이 방침을 수정할 수 있습니다. 변경 사항은 시행 7일 전부터 사이트에 공지하고,
          문서 상단의 시행일을 갱신합니다. 다만 법령 반영이나 표현 수정처럼 이용자에게 불리하지 않은 변경은 공지와 동시에
          시행할 수 있습니다.
        </p>
